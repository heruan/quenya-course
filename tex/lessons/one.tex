...
Thus, one can easily recognize that \q{} (\t{to wish}) or \q{}
(\t{to speak}) are basic verbs. However, ending in \q{} is no absolute
...
of the verb. For derived verbs, the final \q{} can never be the stem
